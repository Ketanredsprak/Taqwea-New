$(function() {
    var classTable = $('#webinar-report-datatable');
    NioApp.DataTable('#webinar-report-datatable', {
        "processing": true,
        "serverSide": true,
        "bDestroy": true,
        "ajax": {

            url: process.env.MIX_APP_URL + "/admin/webinar-report/list",
            type: "get",
        ...
        "columnDefs": [{
            ...
            },
            {
                'data': 'class_detail',
                "name": 'class_detail',
                'targets': 'webinar_detail',
                'defaultContent': '--',
            },
            {
                'data': 'class_description',
                "name": 'class_description',
                'targets': 'webinar_description',
                'defaultContent': '--',
                "render": function(data, type, full, meta) {
    ...
    $('#webinar-report-filter').on('click', function(e) {
