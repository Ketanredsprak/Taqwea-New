            ...
            $('.change-status', row).on('click', function() {
                ...
                if (!isChecked) {
                    ...
                    swalWithBootstrapButtons.fire({
                        title: 'Are you sure?',
                        text: "You want to inactive this class!",
            ...
            },
            {
                ...
                "render": function(data, type, full, meta) {
                    var n = '<ul class="nk-tb-actions gx-1 justify-content-center"\n' +
                        ...
                        '<a href="' + process.env.MIX_APP_URL + '/admin/classes/' + full.id + '"><em class="icon ni ni-eye"></em><span>View</span></a></a>\n' +
                        '</ul>\n' +
                        '</div>\n' +
                        '</div>\n' +
                        '</li>\n' +
