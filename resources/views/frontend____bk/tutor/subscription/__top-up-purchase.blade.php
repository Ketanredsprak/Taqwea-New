            ...
            <div class="modal-body">
                <form action="{{ route('student.checkout.index')}}" method="get" id="addTopUpForm" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="class_hours" class="form-control" placeholder="{{__('labels.enter_top_up_class_purchase')}}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">{{__('labels.top_up_webinar_purchase', ['price'=> __('labels.sar').' '. $topUp->webinar_per_hours_price])}}</label>
                        <input type="text" name="webinar_hours" class="form-control" placeholder="{{__('labels.enter_top_up_webinar_purchase')}}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">{{__('labels.top_up_blog_purchase',  ['price'=> __('labels.sar').' '. $topUp->blog_per_hours_price])}}</label>
                        <input type="text" name="blog" class="form-control" placeholder="{{__('labels.enter_top_up_blog_purchase')}}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">{{__('labels.top_up_is_featured',  ['price'=> __('labels.sar').' '. $topUp->is_featured_price])}}</label>
                        <input type="text" name="is_featured" class="form-control" placeholder="{{__('labels.enter_top_up_is_featured')}}">
                    </div>
                    <div class="btn-row">
