        ...
        <section class="pageTitle">
            <div class="container">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="pageTitle__rideSide d-flex align-items-center">
                        <a href="{{route('tutor.class.schedule')}}?type=" class="font-bd font-bd d-flex align-items-center"><em class="icon-calender">
                            </em>
                            <span class="d-none d-sm-block">{{ __('labels.my_schedule') }}</span>
                        </a>
                        @if($classType=='class')
                        <a href="{{ route('tutor.classes.create') }}" class="font-bd font-bd d-flex align-items-center btn-yellow"><em class="icon-plus"></em> <span class="d-none d-sm-block">{{ __('labels.add_class') }}</span> </a>
                        @else
                        <a href="{{ route('tutor.webinars.create') }}" class="font-bd font-bd d-flex align-items-center btn-yellow"><em class="icon-plus"></em> <span class="d-none d-sm-block">{{ __('labels.add_webinar') }}</span> </a>
                        @endif
                    </div>
                </div>
        </section>
