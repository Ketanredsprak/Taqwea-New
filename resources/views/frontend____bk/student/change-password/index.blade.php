                    ...
                    <div class="column-2">
                        <div class="changePasswordPage__form common-shadow bg-white h-100 p-30">
                            <div class="changePasswordSec">
                                <form action="{{ route('student.change-password.update') }}" method="POST" id="changePasswordForm" novalidate>
                                    <div class="form-group form-group-icon">
                                        <label class="form-label">{{ __('labels.current_password') }}</label>
                                        <input name="current_password" dir="rtl" type="password" class="form-control" placeholder="{{__('labels.enter_current_password')}}" value="" />
                                    ...
                                    <div class="form-group form-group-icon">
                                        ...
                                        <input name="new_password" dir="rtl" type="password" class="form-control" placeholder="{{__('labels.enter_new_password')}}" value="" />
                                    ...
                                    <div class="form-group form-group-icon">
                                        ...
                                        <input name="confirm_password" dir="rtl" type="password" class="form-control" placeholder="{{__('labels.enter_confirm_password')}}" value="" />
                                ...
                                {!! JsValidator::formRequest('App\Http\Requests\Student\ChangePasswordRequest', '#changePasswordForm') !!}
                            </div>
                        </div>
...
@endsection
@push('scripts')
<script type="text/javascript" src="{{asset('assets/js/frontend/student/change-password.js')}}"></script>
@endpush
