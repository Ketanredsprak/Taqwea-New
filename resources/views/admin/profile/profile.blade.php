                                                        ...
                                                        <div class="between-center flex-wrap g-3">
                                                            ...
                                                            <div class="nk-block-actions flex-shrink-sm-0">
                                                                <ul class="align-center flex-wrap flex-sm-nowrap gx-3 gy-2">
                                                                    ...
                                                                    <li>
                                                                        <em class="text-soft text-date fs-12px">Last changed: <span>{{ convertDateToTz($admin->updated_at, 'UTC', 'M d Y')}}</span></em>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md">
                ...
                <form id="profile-update-frm" method="POST" action="javascript:void(0)">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label class="form-label" for="full-name">Name</label>
                        <input type="email" class="form-control form-control-lg" id="full-name" value="{{$admin->name}}" name="name" placeholder="Name">
                    </div>
                    <div class="text-center mt-4">
                        <button id="submit-btn" type="button" class="btn btn-primary width-120 ripple-effect">Update</button>
                        <button type="button" data-dismiss="modal" class="btn btn-light width-120 ripple-effect ml-2">Cancel</button>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md">
                ...
                <form id="change-password-form" action="{{URL::TO('admin/change-password')}}" method="POST">
                    {{csrf_field()}}
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            ...
                            <input type="password" maxlength="32" class="form-control form-control-lg" id="currentPassword" name="current_password" placeholder="Enter current  password" aria-describedby="currentPassword-error">
                        </div>
                        <span id="currentPassword-error" class="invalid-feedback"></span>
                    </div>
                    <div class="form-group">
                        <div class="form-label-group">
                        ...
                        <div class="form-control-wrap">
                            ...
                            <input type="password" maxlength="32" class="form-control form-control-lg" id="newPassword" name="new_password" placeholder="Enter new password" aria-describedby="newPassword-error">
                        </div>
                        <span id="newPassword-error" class="invalid-feedback"></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            ...
                            <input type="password" maxlength="32" class="form-control form-control-lg" id="confirmPassword" name="confirm_password" placeholder="Confirm new password" aria-describedby="confirmPassword-error">
                        </div>
                        <span id="confirmPassword-error" class="invalid-feedback"></span>
                    </div>
                    <div class="text-center mt-4">
                        <button type="button" data-dismiss="modal" class="btn btn-light width-120 ripple-effect mr-2">Cancel</button>
                        <button id="submit-button" type="button" class="btn btn-primary width-120 ripple-effect">Update</button>
                    </div>
