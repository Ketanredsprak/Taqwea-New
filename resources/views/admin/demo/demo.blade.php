            ...
            <div class="nk-content-body">
                        ...
                        <div class="nk-block-head-content">
                            ...
                            <nav>
                                <ul class="breadcrumb breadcrumb-pipe">
                                    ...
                                    <li class="breadcrumb-item active">Demo Management</li>
                                </ul>
                            </nav>
                            <!-- breadcrumb @e -->
                            <h3 class="nk-block-title page-title">Demo Management</h3>
                            ...
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="btn-toolbar gx-sm-1 justify-content-end">
                                        <li>
                                            <a href="{{route('demo.create')}}" class="btn btn-primary"><span>Add Demo</span></a>
                                        </li><!-- li -->
                                    </ul><!-- .btn-toolbar -->
                                </div>
                            </div>
                ...
                <div class="tab-pane fade active show" id="knowledge" role="tabpanel" aria-labelledby="knowledge">
                    <div class="card-inner p-0 common-table bg-white">
                        <table id="demo-datatable" class="table">
                            <thead>
                                <tr>
...
<!-- model add Demo -->
<!-- <div class="modal fade" tabindex="-1" id="addDemo">
</div> -->
<!-- Readmore modal -->
