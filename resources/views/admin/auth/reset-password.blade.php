        ...
        <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
            ...
            <div class="card shadow-none">
                <div class="card-inner card-inner-lg">
                    ...
                    <form id="confirmOtpFrm" method="post" action="{{URL::TO('admin\post-reset-password')}}" novalidate>
                        {{csrf_field()}}
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="4" class="form-control form-control-lg only-number" id="otp" value="{{old('otp')}}" name="otp" placeholder="Enter OTP" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                ...
                                <input type="password" maxlength="32" value="{{old('new_password')}}" class="form-control form-control-lg" id="newPassword" placeholder="Enter new password" name="new_password">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                ...
                                <input type="password" maxlength="32" value="{{old('confirm_password')}}" class="form-control form-control-lg" id="confirmPassword" placeholder="Confirm new password" name="confirm_password">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript" src="{{asset('assets/js/admin/auth/reset-password.js')}}"></script>
@endpush