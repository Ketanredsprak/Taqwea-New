                        ...
                        <div class="nk-block-head-content">
                            ...
                            <nav>
                                <ul class="breadcrumb breadcrumb-pipe">
                                    ...
                                    <li class="breadcrumb-item active">Webinar Report</li>
                                </ul>
                            </nav>
                            <!-- breadcrumb @e -->
                            <h3 class="nk-block-title page-title">Webinar Report</h3>
                        </div>
                        ...
                        <div class="nk-block-head-content pageHead__right">
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <form action="{{route('webinar.export')}}" method="POST">
                                        @csrf
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-right filterDropdown">
                                                        ...
                                                        <div class="dropdown-foot">
                                                            ...
                                                            <button type="button" id="webinar-report-filter" class="btn btn-primary">Filter</button>
                                                        </div>
                                                    </div><!-- .filter-wg -->
                                                </div><!-- .dropdown -->
                                            </li>
                        ...
                        <div class="card-aside-wrap">
                            <div class="w-100">
                                <div class="card-inner p-0 common-table">
                                    <table class="datatable-init table" id="webinar-report-datatable">
                                        <thead>
                                            <tr>
                                                <th class="w_70 id">ID</th>
                                                <th class="tutor_name">Tutor Name</th>
                                                <th class="webinar_description">Webinar description</th>
                                                <th class="webinar_capacity">Webinar Capacity</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <!-- xxxxx -->
...
@endsection
@push('scripts')
<script src="{{asset('assets/js/admin/reports/webinar-report.js')}}"></script>
@endpush