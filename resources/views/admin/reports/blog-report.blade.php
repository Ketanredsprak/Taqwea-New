                        ...
                        <div class="nk-block-head-content">
                            ...
                            <nav>
                                <ul class="breadcrumb breadcrumb-pipe">
                                    ...
                                    <li class="breadcrumb-item active">Blog Report</li>
                                </ul>
                            </nav>
                            <!-- breadcrumb @e -->
                            <h3 class="nk-block-title page-title">Blog Report</h3>
                        </div>
                        ...
                        <div class="nk-block-head-content pageHead__right">
                            <div class="toggle-wrap nk-block-tools-toggle">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <form action="{{ route('blog.export')}}" method="POST">
                                        @csrf
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-right filterDropdown">
                                                        ...
                                                        <div class="dropdown-foot">
                                                            ...
                                                            <button id="blog-report" type="button" class="btn btn-primary">Filter</button>
                                                        </div>
                                                    </div><!-- .filter-wg -->
                                                </div><!-- .dropdown -->
                                            </li>
                        ...
                        <div class="card-aside-wrap">
                            <div class="w-100">
                                <div class="card-inner p-0 common-table">
                                    <table class="datatable-init table" id="blog-report-datatable">
                                        <thead>
                                            <tr>
                                                <th class="w_70 id">ID</th>
                                                <th class="tutor_name">Tutor Name</th>
                                                <th class="blog_title">Blog Title</th>
                                                <th class="blog_description">Blog Description</th>
                                                <!-- <th class="blog_capacity">Blog Capacity</th> -->
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <!-- xxxxx -->
...
@endsection
@push('scripts')
<script src="{{asset('assets/js/admin/reports/blog-report.js')}}"></script>
@endpush
