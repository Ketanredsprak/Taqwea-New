                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <nav>
                                <ul class="breadcrumb breadcrumb-pipe">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.blog.purchase')}}">Blog</a></li>
                        ...
                        <div class="nk-block-head-content pageHead__right">
                            <div class="toggle-wrap nk-block-tools-toggle">
                                <a href="{{route('admin.blog.purchase')}}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                            </div>
                        </div>
