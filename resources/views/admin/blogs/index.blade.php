                                                        ...
                                                        <div class="row gx-6 gy-3">
                                                            <div class="col-12">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <select id="category_id" class="form-select form-select-sm" data-placeholder="Category">
                                                                        <option></option>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group ">
                                                                    <label class="overline-title overline-title-alt">Content Type</label>
                                                                    <select id="contentType" class="form-select form-select-sm" data-placeholder="Content Type">
                                                                        <option></option>
                                    ...
                                    <table id="blog-table" class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="created_at">Published On </th>
...
<script type="text/javascript" src="{{asset('assets/js/admin/blogs/index.js')}}"></script>
@endpush