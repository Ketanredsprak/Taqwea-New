                        ...
                        <div class="walletPage__content common-shadow bg-white p-30">
                            ...
                            <div class="walletPage__table">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                     ...
                                     {{-- <div class="col-sm-2">
                                            ...
                                            <a href="{{ route('tutor.classrequest.create') }}" type="button" class="btn btn-primary btn-sm btn-lg text-right">Add</a>
                                ...
                                <div class="searchList common-table" nice-scroll>
                                    ...
                                    <div class="table-responsive" id="tutorClassRequestList">
...
<script type="text/javascript" src="{{asset('assets/js/frontend/tutor/class-request.js')}}"></script>
