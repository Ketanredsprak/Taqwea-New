                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="step1-english" role="tabpanel">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="en[name]" type="text" class="form-control name_en" id="name_en" placeholder="{{ __('labels.enter_name') }}" {{ ($user->name)?'disabled':'' }} autocomplete="nope" dir="rtl">

                                            @if($user->name)

                                            <input name="en[name]" type="hidden" value="{{ $user->name }}" dir="rtl">
                                        ...
                                        <div class="form-group" style="display: none">
                                            ...
                                            <input name="ar[name]" type="hidden" value="{{ $user->name }}" dir="rtl">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control email_en" placeholder="{{ __('labels.enter_email_id') }}" {{ ($user->email)?'disabled':'' }} autocomplete="nope" dir="rtl">
