                        ...
                        <div class="boxContent-form position-relative">
                            <form action="{{ route('signup') }}" method="post" id="completeSignUpForm" novolidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" dir="rtl" value="{{ @$user->name }}" type="text" class="form-control" placeholder="{{ __('labels.enter_name') }}" {{ (@$user->name)?'disabled':'' }}>
                                    @if(@$user->name)
                                    <input name="name" dir="rtl" value="{{ @$user->name }}" type="hidden" class="form-control">
                                    @endif
                                </div>
                                <div class="form-group">
                                    <label class="form-label">{{ __('labels.email_id') }}</label>
                                    <input name="email" dir="rtl" value="{{ @$user->email }}" type="email" class="form-control" placeholder="{{ __('labels.enter_email_id') }}" {{ (@$user->email)?'disabled':'' }}>
                                    @if(@$user->email)
                                    <input name="email" dir="rtl" value="{{ @$user->email }}" type="hidden" class="form-control">
                                    @endif
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="referral_code" dir="rtl" type="text" class="form-control" placeholder="{{ __('labels.referral_code') }}">
                                </div>
                                <div class="submitBtn">
