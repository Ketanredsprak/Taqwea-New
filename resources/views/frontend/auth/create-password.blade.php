                        ...
                        <div class="boxContent-form position-relative">
                            <form action="{{ url('forgot-password/create-password') }}" id="createPasswordFrom" novolidate>
                                ...
                                <div class="form-group form-group-icon">
                                    ...
                                    <input name="new_password" type="password" dir="rtl" class="form-control" placeholder="{{ __('labels.enter_password') }}">
                                ...
                                <div class="form-group form-group-icon">
                                    ...
                                    <input name="confirm_password" type="password" dir="rtl" class="form-control" placeholder="{{ __('labels.confirm_password') }}">
