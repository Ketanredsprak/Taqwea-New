                    ...
                    <div class="flexRow d-xl-flex">
                        ...
                        <div class="column-2">
                            ...
                            <div class="editProfilePage__Form commonBox">
                                ...
                                <a href="{{ route('student.classrequest.index') }}" class="btn btn-primary btn-sm"><em
                                        class="icon-arrow-back"></em></a>

                                <div class="editFormSec">

                                    <h2 class="text-center">{{ __('labels.generate_class_request') }}</h2> <br>
                                    ...
                                    <form action="{{ route('student.classrequest.store') }}" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="radio" id="click_single" name="class_type"
                                                        value="Single" checked> <label for="Single">
                                                        {{ __('labels.single') }}</label>

                                                    <input type="radio" id="click_multiple" name="class_type"
                                                        value="Multiple" class="click_multiple"> <label
                                                        for="Multiple">{{ __('labels.multiple') }}</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea type="text" name="note" id="message" class="form-control" rows="5" dir="rtl"></textarea>
