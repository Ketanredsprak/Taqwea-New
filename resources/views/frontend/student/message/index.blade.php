...
<main class="mainContent">
    <div class="chatPage chatPage--student commonPad bg-green">
                    ...
                    <div class="userList commonBox sideMenu" >
                        ...
                        <form>
                            <div class="form-group search">
                                ...
                                <input type="text" dir="rtl" class="form-control" id="search-text" placeholder="{{__('labels.search_by_class_tutor_name')}}">
                                <button type="button" class="search-clear" id="tutor-search-chat" style="display: none;" ><i class="icon-close"></i></button>
                            </div>
                        </form>
                        <div id="chatList"></div>
                    </div>
...
<script type="text/javascript" src="{{asset('assets/js/frontend/student/chat.js')}}"></script>
@endpush
