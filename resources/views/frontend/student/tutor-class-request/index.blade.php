                ...
                <div class="commonBreadcrumb">
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('labels.tutor_class_request')}}</li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$data->price}}</td>
                                                     ...
                                                     <td>
                                                        ...
                                                        <a href="#" onclick="Approvereq('{{ $data->id }}','{{ $data->class_request_id }}')" type="button" class="btn btn-success btn-sm btn-lg text-right" title="Accept"><em class="icon-right"></em></a>


                                                        <a href="#" onclick="RejectTutorRequest('{{ $data->id }}','{{ $data->class_request_id }}')" type="button" class="btn btn-danger btn-sm btn-lg text-right" title="Reject"><em class="icon-delete"></em></a>



                                                        <a href="{{ route('featured.tutors.show', ['tutor' => $data->tutor_id]) }}" type="button" class="btn btn-info btn-sm btn-lg text-right" title="View Tutor Profile"><em class="icon-eye"></em></a>
