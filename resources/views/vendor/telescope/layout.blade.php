...
<head>
    ...
    <title>Tracking {{ config('app.name') ? ' - ' . config('app.name') : '' }}</title>
...
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-3"><strong></strong>{{ config('app.name') ? ' - ' . config('app.name') : '' }}</h4>
            ...
            <a class="btn btn-outline-primary mr-3" href="/admin">
               Back
            </a>
...
<script>
    ...
    window.Telescope.path = 'admin/tracking';
</script>
</script>
