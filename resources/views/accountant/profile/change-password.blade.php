                                ...
                                <div class="card-inner-group" data-simplebar>
                                    <div class="card-inner">
                                        <div class="user-card">
                                            ...
                                            <div class="user-info">
                                                <span class="lead-text">{{$accountant->name}}</span>
                                    ...
                                    <div class="card-inner p-0">
                                        <ul class="link-list-menu nav m-0">
                                            <li><a data-toggle="tab" href="#tabItem1"><em class="icon ni ni-user-fill-c"></em><span>Profile</span></a></li>
                                            <li><a class="active" data-toggle="tab" href="#tabItem2"><em class="icon ni ni-lock-alt-fill"></em><span>Change Password</span></a></li>
                                        </ul>
                                    </div><!-- .card-inner -->
                                </div><!-- .card-inner-group -->
                            </div>
                ...
                <form id="change-password-form" action="{{URL::TO('admin\change-password')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            ...
                            <input type="password" name="current_password" class="form-control form-control-lg" id="currentPassword" placeholder="Enter current  password" aria-describedby="currentPassword-error"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            ...
                            <input type="password" name="new_password" class="form-control form-control-lg" id="newPassword" placeholder="Enter new password" aria-describedby="newPassword-error"/>
                        </div>
                    ...
                    <div class="form-group passwordInfo">
                        ...
                        <p><em class="icon ni ni-check"></em> 8-15 characters long.</p>
                    </div>
                    <div class="form-group">
                        <div class="form-label-group">
                        ...
                        <div class="form-control-wrap">
                            ...
                            <input type="password" name="confirm_password" class="form-control form-control-lg" id="confirmPassword" placeholder="Confirm new password" aria-describedby="confirmPassword-error"/>
                        </div>
