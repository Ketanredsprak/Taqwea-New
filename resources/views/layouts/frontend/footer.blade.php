        ...
        <div class="row footer__lower">
            <div class="col-lg-4">
                <div class="footer__img footer__img--footerlogo d-flex align-items-center">
                    ...
                    <a  target="_blank" href="{{getSetting('app_store_link')}}">
            ...
            <div class="col-lg-8">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12 col-lg-4">
                        <a href="javascript:void(0);"><img src="{{ (app()->getLocale()=='ar')?asset('assets/images/card-img-ar.png'):asset('assets/images/card-img.png') }}" class="img-fluid" alt="card">
                        </a>
                    </div>
                </div>
            </div>
