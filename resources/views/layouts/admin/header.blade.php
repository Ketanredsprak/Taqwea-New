<div class="nk-header nk-header-fixed is-light">
    <div class="container-fluid">
        <div class="nk-header-wrap">
            <div class="nk-menu-trigger mr-2 p-0">
            ...
            <div class="nk-header-brand">
                <a href="{{route('adminDashboard')}}" class="logo-link">
                        ...
                        <div class="dropdown-menu headerDropdown dropdown-menu-md dropdown-menu-right">
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    ...
                                    <div class="user-info">
                                        <span class="lead-text text-capitalize">{{Auth::guard('web')->user()->name}}</span>
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="{{URL::TO('admin\profile')}}"><em class="icon ni ni-user-alt"></em><span>Profile Settings</span></a></li>
                                    <li><a href="{{URL::TO('admin\profile')}}"><em class="icon ni ni-lock-alt-fill"></em><span>Change Password</span></a></li>
                                    <li><a href="{{URL::TO('admin\setting')}}"><em class="icon ni ni-setting"></em><span>Settings</span></a></li>
                                </ul>
                            </div>
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="{{route('admin-logout')}}"><em class="icon ni ni-signout"></em><span>Logout</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
