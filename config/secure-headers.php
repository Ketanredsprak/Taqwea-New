    ...
    'csp' => [
        ...
        'script-src' => [
            ...
            'allow' => [
                ...
                'https://download.agora.io/sdk/release/AgoraRTC_N-production.js.map',
                'https://download.agora.io/sdk/release/AgoraRTC_N-4.7.1.js',
                ...
                'https://cdnjs.cloudflare.com/ajax/libs/apexcharts/2.4.0/apexcharts.min.js',
                ...
                config('app.socket_url').'/socket.io/socket.io.js',
                'https://cdn.jsdelivr.net/npm/fullcalendar@5.3.1/main.min.js',
                'https://sdk.netless.link/white-web-sdk/2.13.11.js'
            ],
        ...
        'style-src' => [
            ...
            'https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.1.0/fullcalendar.css',
            'https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.1.2/css/tempusdominus-bootstrap-4.min.css',
            'https://cdn.jsdelivr.net/npm/fullcalendar@5.3.1/main.min.css'
        ],
