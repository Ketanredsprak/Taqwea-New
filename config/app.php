...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This key is used for set application default currency
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This key is used for Hyper pay payment getaway
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This key is used for socket connection
    |
    */
    ...
    */
    ...
    'aliases' => [
        ...
        'RaiseHand' => App\Models\RaiseHand::class,
