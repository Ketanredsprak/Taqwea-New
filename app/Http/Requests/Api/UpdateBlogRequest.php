...
class UpdateBlogRequest extends ApiRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'en.blog_title' => 'required|string|min:6|max:255|unique:App\Models\BlogTranslation,blog_title',
            'en.blog_description' => 'required|string|min:2|max:5000',
            'ar.blog_title' => 'nullable|string|min:6|max:255|unique:App\Models\BlogTranslation,blog_title',
